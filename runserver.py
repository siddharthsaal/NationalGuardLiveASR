...
# Monkeypatch tqdm to fix 'disabled_tqdm' has no attribute '_lock' error
try:
    from tqdm.std import disabled_tqdm
    if not hasattr(disabled_tqdm, "_lock"):
        disabled_tqdm._lock = None
except ImportError:
    pass
